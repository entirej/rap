...
public class EJRWTFormChosenEvent extends EventObject
{
     ...
     * @param formName
     */
    public EJRWTFormChosenEvent(String formName)
    {
        super(formName);
        setChosenFormName(formName);
    }

    public EJRWTFormChosenEvent(String formName, boolean queryMode)
    {
        super(formName);
        setChosenFormName(formName);
