...
public class EJRWTStatusbarRendererDefinition implements EJDevAppComponentRendererDefinition, EJDevAppComponentPreviewProvider
{
    ...
    {
        return EJRWTPreviewDescriptors.descriptor(EJDevPreviewKind.STATUS_BAR);
    }
    ...
    {
        return "org.entirej.applicationframework.rwt.application.components.EJRWTStatusbar";
    }
