...
public class EJRWTTableRendererDefinitionControl extends EJDevLovRendererDefinitionControl
{
    private Table                               _table;
    private Map<String, Integer>                _columnPositions;
    private List<EJDevItemWidgetChosenListener> _itemWidgetListenerList;

    public EJRWTTableRendererDefinitionControl(EJDevLovDefinitionDisplayProperties lovDisplayProperties, Table table, Map<String, Integer> columnPositions)
    {
