...
public class EJRWTImageItemRendererDefinition implements EJDevItemRendererDefinition, EJDevItemPreviewProvider
{
    ...
    {
        return EJRWTPreviewDescriptors.descriptor(EJDevPreviewKind.IMAGE);
    }
