...
public class EJRWTDropDownRendererDefinition implements EJDevItemRendererDefinition, EJDevItemPreviewProvider
{
    ...
    public EJRWTDropDownRendererDefinition()
    {
    }

    public String getRendererClassName()
    {
        return "org.entirej.applicationframework.rwt.renderers.item.EJRWTDropDownItemRenderer";
    }
    ...
    {
        EJDevPropertyDefinitionGroup mainGroup = new EJDevPropertyDefinitionGroup("Drop Down Renderer");
        mainGroup
                .setDescription("Drop Down contain a list of data which is retreved from an Lov Definition. To give your Drop Down static values, create a service tha returns the static data, create an Lov Definition based on this service and then assign the Lov Definition to the Combo Box");
        ...
        autorefreshLov
                .setDescription("Because Drop Down are based upon lov definitions, lov query mapping value changes will auto refresh combo content");
        ...
        initialiseLov
        .setDescription("Because Drop Down are based upon lov definitions, they need to make a query to be created. Thsi could take time dependin on how many Drop Down you are displaying. You can set the Populate On Creation to false to delay the population of the Combo Box until either the items gets set to a value in the action processor or you request that the item renderer be refreshed");
    ...
    {
        Text combo = new Text(parent, SWT.BORDER);
