...
public class EJRWTCheckBoxRendererDefinition implements EJDevItemRendererDefinition
{
    ...
    {
        return "org.entirej.applicationframework.rwt.renderers.item.EJRWTCheckBoxItemRenderer";
    }
    ...
    public EJPropertyDefinitionGroup getItemPropertyDefinitionGroup()
    {
        ...
        EJDevPropertyDefinition otherValueMapping = new EJDevPropertyDefinition(EJRWTCheckBoxRendererDefinition.OTHER_VALUE_MAPPING,
