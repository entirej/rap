...
public class EJRWTExtHtmlViewItemRendererDefinition implements EJDevItemRendererDefinition
{
    ...
    public EJRWTExtHtmlViewItemRendererDefinition()
    {
    }

    public String getRendererClassName()
    {
        return "org.entirej.applicationframework.rwt.renderers.html.EJRWTExtHtmlViewItemRenderer";
    }
    ...
    {
        EJDevPropertyDefinitionGroup mainGroup = new EJDevPropertyDefinitionGroup("Ext Html View Item Renderer");
