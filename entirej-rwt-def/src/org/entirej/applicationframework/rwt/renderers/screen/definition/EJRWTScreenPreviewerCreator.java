...
public class EJRWTScreenPreviewerCreator
{
    public List<EJDevItemRendererDefinitionControl> addUpdateScreenPreviewControl(EJRWTScreenRendererDefinition screenRenderer,
    ...
    public List<EJDevItemRendererDefinitionControl> addInsertScreenPreviewControl(EJRWTScreenRendererDefinition screenRenderer,
            EJDevBlockDisplayProperties blockDisplayProperties, Composite blockParent, FormToolkit toolkit)
    {
        List<EJDevItemRendererDefinitionControl> itemControls = new ArrayList<EJDevItemRendererDefinitionControl>();
    ...
    public List<EJDevItemRendererDefinitionControl> addQueryScreenPreviewControl(EJRWTScreenRendererDefinition screenRenderer,
            EJDevBlockDisplayProperties blockDisplayProperties, Composite blockParent, FormToolkit toolkit)
    {
        List<EJDevItemRendererDefinitionControl> itemControls = new ArrayList<EJDevItemRendererDefinitionControl>();
    ...
    private void addItemGroup(Composite parent, EJRWTScreenRendererDefinition screenRenderer, EJDevBlockDisplayProperties blockDisplayProperties,
    ...
    private class ItemCreator
    {
                ...
                EJDevScreenItemDisplayProperties screenItemProperties, Composite blockCanvas, FormToolkit toolkit)
        {
            ...
            String labelPosition = screenRequiredItemProperties.getStringProperty(EJRWTScreenRendererDefinitionProperties.LABEL_POSITION_PROPERTY);
            String labelOrientation = screenRequiredItemProperties.getStringProperty(EJRWTScreenRendererDefinitionProperties.LABEL_ORIENTATION);
            ...
            if (hasLabel && (screenItemProperties.getLabel() != null && screenItemProperties.getLabel().trim().length() > 0))
            {
                ...
                if (EJRWTScreenRendererDefinitionProperties.LABEL_POSITION_RIGHT_PROPERTY.equals(labelPosition))
                {
        ...
        public EJDevItemRendererDefinitionControl addSpacerItem(EJRWTScreenRendererDefinition screenRenderer, Composite canvas,
