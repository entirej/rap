...
public class EJRWTSingleRecordBlockDefinition implements EJDevBlockRendererDefinition, EJDevBlockPreviewProvider
{
    ...
    {
        return EJRWTPreviewDescriptors.block(EJDevPreviewKind.BLOCK, mainScreenProperties);
    }
    @Override
