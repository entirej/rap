...
public class EJRWTTableRendererDefinitionControl extends EJDevBlockRendererDefinitionControl
{
    private Table                               _table;
    private Map<String, Integer>                _columnPositions;
    private List<EJDevItemWidgetChosenListener> _itemWidgetListenerList;

    public EJRWTTableRendererDefinitionControl(EJDevBlockDisplayProperties blockDisplayProperties, Table table, Map<String, Integer> columnPositions)
    {
