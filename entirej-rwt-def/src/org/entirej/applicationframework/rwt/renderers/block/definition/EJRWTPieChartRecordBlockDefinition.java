...
public class EJRWTPieChartRecordBlockDefinition implements EJDevBlockRendererDefinition, EJDevBlockPreviewProvider
{
    ...
    public EJPropertyDefinitionGroup getBlockPropertyDefinitionGroup()
    {
        ...
        viewType.addValidValue("polarArea", "Polar Area");
    ...
    {
        return EJRWTPreviewDescriptors.block(EJDevPreviewKind.CHART, mainScreenProperties);
    }
    @Override
