...
public class EJRWTTreeRendererDefinitionControl extends EJDevBlockRendererDefinitionControl
{
    private Tree                               _table;
    private Map<String, Integer>                _columnPositions;
    private List<EJDevItemWidgetChosenListener> _itemWidgetListenerList;

    public EJRWTTreeRendererDefinitionControl(EJDevBlockDisplayProperties blockDisplayProperties, Tree table, Map<String, Integer> columnPositions)
    {
